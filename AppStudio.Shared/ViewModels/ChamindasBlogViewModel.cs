...
{
    public class ChamindasBlogViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ChamindasBlogDetail", item);
                        });
                }
        ...
        {
            return new ChamindasBlogDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ChamindasBlogList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ChamindasBlogDetail");
        }
    }
}
