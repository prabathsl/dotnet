...
{
    public class PrabathsBlogViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("PrabathsBlogDetail", item);
                        });
                }
        ...
        {
            return new PrabathsBlogDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("PrabathsBlogList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("PrabathsBlogDetail");
        }
    }
}
