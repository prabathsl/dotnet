...
{
    public class MalinsBlogViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("MalinsBlogDetail", item);
                        });
                }
        ...
        {
            return new MalinsBlogDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("MalinsBlogList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("MalinsBlogDetail");
        }
    }
}
